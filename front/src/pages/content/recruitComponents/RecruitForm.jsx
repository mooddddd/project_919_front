...
export const RecruitForm = ()=>{
    ...
    <FormContent method="post">
        <ul>
            ...
            <li>
                <div className="left">플랜 종류</div>
                <select/> <select/>
            </li>

            <li>
                <div className="left">글제목</div>
                <Input width="30rem" height={height} 
            ...
            <li>
                <div className="left">예상 시작 날짜</div>
                <Input type="date" width="9rem" height={height}/>
            </li>

            <li>
                <div className="left">예상 종료 날짜</div>
                <Input type="date" width="9rem" height={height}/>
            </li>

            <li>
            <div className="left">오픈채팅방 링크</div>
            <Input width="80%" height={height} 
            placeholder="(파티원들끼리 소통할 채팅방의 링크를 입력해주세요.)"/> 
            </li>

            <li>
                <div className="left">공지사항</div>
                <Textarea width="80%" height="10rem" 
        ...
        <Button type="submit" width="15rem" height="3rem">파티 생성!</Button>
    </FormContent>
    </>
}